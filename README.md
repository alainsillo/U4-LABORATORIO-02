...
Lee el código desde un archivo (codigo_fuente.txt)

Detecta todos los tokens importantes (palabras reservadas, identificadores, operadores, números, etc.)

Ignora comentarios, espacios y saltos de línea
